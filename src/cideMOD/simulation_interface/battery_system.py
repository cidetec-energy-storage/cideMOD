...
class CSI:
    def __init__(self, cell_data:Union[dict,str], simulation_type:dict={}, data_path:str=None, name:str=None, overwrite=False, save_path=None):
        ...
        if name is None and save_path is None:
            ...
            self.save_path = init_results_folder(os.path.join(save_path or '', name or '').rstrip('/'), overwrite=overwrite, 
                                                 copy_files=[cell_data, self.simulation_options.dict()], filenames=['params', 'simulation_options'])
