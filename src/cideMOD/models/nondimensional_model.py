...
class NondimensionalModel(ThermalModel, MechanicModel, SolventLimitedSEIModel, ElectrochemicalModel):
    def physical_variables(self, problem):
        ...
        if 'phi_s_cc' in problem.f_1.var_names:
            ...
            phi_s_cc = 0
        c_s_a_index = problem.f_1.var_names.index('c_s_0_a0')
        ...
        c_s_c_index = problem.f_1.var_names.index('c_s_0_c0')
        ...
        j_Li_a_index = problem.f_1.var_names.index('j_Li_a0')
        ...
        j_Li_c_index = problem.f_1.var_names.index('j_Li_c0')
